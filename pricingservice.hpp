...
/**
 * Pre-declarations to avoid errors
 */
 template<typename T>
...
public:
    ...
    // Add a listener to the Service for callbacks on add, remove and update events for the data to the Service
