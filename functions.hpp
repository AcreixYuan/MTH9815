//
// Created by Suyang Yuan on 12/23/23.
//

#ifndef FINAL_PROJECT_FUNCTIONS_HPP
#define FINAL_PROJECT_FUNCTIONS_HPP
...
// Generate uniformly distributed random variables between 0 and 1
...
string ConvertPrice(double _doublePrice) {
    ...
    int _doublePrice256 = floor((_doublePrice - _doublePrice100) * 256);
...
#endif //FINAL_PROJECT_FUNCTIONS_HPP
